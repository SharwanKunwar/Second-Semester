# create a structure "employee having a name, department address, salary and age as number function. display the name of the employee having age between30 and 50 are living in kathmandu."
